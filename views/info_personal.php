          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Admon Información Básica</h3>
              </div>
              <div class="card-body">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card-body p-0">
                    <table class="table display responsive wrap" id="socialMedia_data">
                      <thead>
                        <tr>
                          <th class="wd-15p">Información de Nacimiento</th>
                          <th class="wd-15p"># Celular</th>
                          <th class="wd-15p">Email</th>
                          <th class="wd-15p">Información Url</th>
                          <th class="wd-15p">Información Cargo</th>
